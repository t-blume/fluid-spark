...
class IGSI_NEW(database: String, trackChanges: Boolean) extends Serializable {
...
//    val conf = new SparkConf().setAppName("Sample Data Frame App").
//      setMaster("local[*]")
//
//    val sc = new SparkContext(conf)
//    val sqlContext = new SQLContext(sc)
//
//    val ORIENTDB_CONNECTION_URL = "remote:localhost/till-test"
//    val ORIENTDB_USER = "admin"
//    val ORIENTDB_PASSWORD = "admin"
//    val test = sqlContext.read.format("org.apache.spark.orientdb.graphs").option("dburl", ORIENTDB_CONNECTION_URL)
//      .option("user", ORIENTDB_USER)
//      .option("password", ORIENTDB_PASSWORD)
//      .option("vertextype", "SchemaElement")
//      .load()
//
